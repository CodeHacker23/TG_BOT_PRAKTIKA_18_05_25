...
public class MarkdownUtil {
     ...
     *
     * 14. Если не понял — перечитай ещё раз, потом выпей кофе, потом спроси у Илариона.
     *
     ...
     *
     * 17. Если забудешь экранировать спецсимволы — Иларион лично напишет тебе в Telegram (и не только).
     *
     * =========================
     *
