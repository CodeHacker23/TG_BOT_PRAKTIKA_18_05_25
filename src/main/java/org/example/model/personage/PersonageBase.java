 ...
 *
 * Юмор: если скопируешь поля из PersonageBase в Personage4 — Иларион лично напишет тебе в Telegram.
 */
@Data
public abstract class PersonageBase {
    ...
    /**
     * Абстрактный метод для повышения базовых статов (опыт и деньги).
    ...
    // 4. Если добавишь персонажа без комментария — Иларион лично напишет тебе в Telegram.
}
