 ...
 *
 * Юмор: если добавишь бизнес-логику в UserEntity — Иларион лично напишет тебе в Telegram.
 */
@Entity
@Data
@Table(name = "users")
public class UserEntity {
    ...
    // 3. Если добавишь поле без комментария — Иларион лично напишет тебе в Telegram.
}
